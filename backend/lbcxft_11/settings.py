"""
Django settings for lbcxft_11 project.
...
WSGI_APPLICATION = 'lbcxft_11.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lbcxft_11 API",
    "DESCRIPTION": "API documentation for lbcxft_11 App",
    "VERSION": "v1",
}
